...
type QueryYml struct {
	...
	// Path to client folder e.g. "github.com/arnac-io/osmosis/v17/x/twap/client"
...
type Keeper struct {
	// e.g. github.com/arnac-io/osmosis/v17/x/twap
...
// input is of form github.com/arnac-io/osmosis/vXX/{PATH}
// returns PATH
